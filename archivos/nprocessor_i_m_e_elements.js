...
function do_save(){
    ...
    console.log(jsonStr);
    if(confirm("Desea sobreescribir el evento actual?")){
    	//peticion AJAX para obtener los valores del elemento asociado
	    $.ajax({
...
function create_event(jsonStr_) {
	fees = new Array();
	...
	create_window_edit("div_create_event", "NAN", 582, 170, fees, "#FFFFFF", "#333333", "#000000", "/ProgrammeProcessorServer/EventProcessorServlet", "11", "Crear Evento","descriptor="+jsonStr_);
}
